    ...
    <!--<div :id="'carousel_' + item.prefix" class="carousel slide" data-ride="carousel">-->
        ...
        <!--<div class="carousel-inner" role="listbox">-->
            <!--<div class="carousel-item active">-->
                <!--<img class="d-block w-100" :src="'images/' + item.prefix + '_icon.jpg'" alt="">-->
            <!--</div>-->
            <!--<div class="carousel-item">-->
                <!--<img class="d-block w-100" :src="'images/' + item.prefix + '1.jpg'" alt="">-->
            <!--</div>-->
            <!--<div class="carousel-item">-->
                <!--<img class="d-block w-100" :src="'images/' + item.prefix + '2.jpg'" alt="">-->
            <!--</div>-->
            <!--<div class="carousel-item">-->
                <!--<img class="d-block w-100" :src="'images/' + item.prefix + '3.jpg'" alt="">-->
            <!--</div>-->
            <!--<div class="carousel-item">-->
                <!--<img class="d-block w-100" :src="'images/' + item.prefix + '4.jpg'" alt="">-->
            <!--</div>-->
        <!--</div>-->
